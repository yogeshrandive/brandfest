...
const DEFAULT_OFFER: OfferInput = {
  ...
  validity: "",
  promptHints:
    "celebratory abstract background, brand gold accents, warm festive tones, clean lower area for text overlay, no text, no letters",
  theme: "promo",
};
...
export default function Home() {
  ...
  async function generate() {
    ...
    try {
      const body =
        mode === "occasion"
          ? { mode, occasion: selectedOccasion, sizes }
          : { mode, offer, sizes };
